      ...
      <div className="flex flex-col gap-8">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your unique wallet address for receiving funds</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              <code className="text-sm font-mono truncate">{walletAddress}</code>
          ...
          <CardContent>
            <Tabs defaultValue="transactions">
              ...
              <TabsContent value="activity" className="pt-4 space-y-4">
                <ActivityItem action="Login" details="New login from Chrome on Windows" date="Today, 9:15 AM" />
                <ActivityItem
                ...
                <ActivityItem
                  ...
                  date="May 3, 2025"
                />
                <ActivityItem action="Account Created" details="Welcome to AfriPay!" date="May 1, 2025" />
              </TabsContent>
            </Tabs>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-between items-center p-3 rounded-lg hover:bg-muted/50">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Get notified about wallet activities</p>
              </div>
